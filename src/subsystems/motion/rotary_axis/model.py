...
from .abi import Result, FUNCTIONS, CONTROL_ERROR
from protocols.sdk.contracts import SDKModel
...
# Device-local constants; other hardware must define its own behavior and values.
...
def create():
    ...
    from .adapter import RotaryAdapter
    from .build import build_reference_sdk
    return SDKDefinition(RotaryAxis, RotaryAdapter, build_reference_sdk)
